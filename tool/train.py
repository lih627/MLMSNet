...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/cityscapes_ohem_large.yaml', help='config file')
    parser.add_argument('opts', help='see config/cityscapes_ohem_large.yaml for all options', default=None,
...
def check(args):
    ...
    print('Please add check for arch {}'.format(args.arch))
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.loss == 'ce':
        ...
        criterion = OhemCELoss(thresh=0.7, ignore_lb=args.ignore_label)
    if args.arch == 'baseline':
        from model.baseline import BaselineNet
        model = BaselineNet(mode=args.mode, width_mult=args.width_mult, zoom_factor=args.zoom_factor,
                            criterion=criterion, classes=args.classes, atrous3=args.atrous3, atrous4=args.atrous4)
